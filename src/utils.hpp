...
//   static FILE *memfile() {
//     static FILE *file = fdopen(memfd(), "w+");
//     return file;
//   }
...
//     switch (C) {
//     case components::core: return "https://hertz.services/docker/codehz/cobblestone/0";
//     case components::game: return "https://hertz.services/docker/codehz/bds/0";
...
//       path base = path{ ".cobblestone" } / name();
...
void start_nsgod(size_t) {
  ...
  char const *const xenv[] = {
      "NSGOD_API=ws+unix://.cobblestone/nsgod.socket",
      "NSGOD_LOCK=.cobblestone/nsgod.lock",
      nullptr,
  };
  posix_spawn(&pid, ".cobblestone/nsgod", nullptr, nullptr, (char *const *)xarg, (char *const *)xenv);
  wait(nullptr);
  if (!exists(".cobblestone/nsgod.socket")) {
